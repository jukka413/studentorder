...
{
    private String certificateNumber;  //Номер св-ва о рождении
    private LocalDate issueDate;       //Дата выдачи св-ва
    private RegisterOffice issueDepartment;    //Кем выдано св-во
